...
func addRepoStatsSegment(nChanges int, symbol string, foreground uint8, background uint8) []types.Segment {
	if nChanges > 0 {
...
func (r repoStats) GitSegments(p *types.Powerline) (segments []types.Segment) {
...
func (r repoStats) GitSymbols(p *types.Powerline) string {
	var info string
...
func getGitDetachedBranch(p *types.Powerline) string {
...
func segmentGit(p *types.Powerline) []types.Segment {
