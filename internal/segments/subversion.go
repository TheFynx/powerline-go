...
func addSvnRepoStatsSegment(p *types.Powerline, nChanges int, symbol string, foreground uint8, background uint8) (segments []types.Segment) {
	if nChanges > 0 {
...
func (r repoStats) SvnSegments(p *types.Powerline) (segments []types.Segment) {
...
func segmentSubversion(p *types.Powerline) []types.Segment {
